...
This example demonstrates how to generate an analytics report for email engagements using the HubSpot CRM Email Engagements connector. The script fetches all email engagement records, categorizes them by status (sent, bounced, failed, scheduled), and prints a summary report to the console.
...
Total Emails Bounced : 2
Total Emails Failed  : 1
Total Emails Scheduled    : 5
```