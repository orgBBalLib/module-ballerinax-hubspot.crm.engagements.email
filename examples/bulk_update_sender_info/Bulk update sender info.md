...
Execute the following command to run the example. The script will retrieve all email engagements, identify scheduled emails, and update their sender information, printing progress to the console.
