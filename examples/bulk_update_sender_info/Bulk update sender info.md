...
Execute the following command to run the example. The script will retrieve all emails, update the sender information for scheduled emails, and print the progress to the console.
