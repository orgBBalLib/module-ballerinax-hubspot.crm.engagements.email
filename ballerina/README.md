...
6. Navigate to the Scopes tab and select the required scopes for CRM engagements email access (e.g., `crm.objects.contacts.read`, `crm.objects.contacts.write`, `sales-email-read`).
...
public function main() returns error? {
    hsemail:SimplePublicObjectInputForCreate newEmail = {
        ...
        properties: {
            ...
            "hs_email_text": "Thank you for reaching out. We wanted to follow up on your recent inquiry."
        }
    };
