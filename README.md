...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage their marketing, sales, customer service, and content management through an integrated suite of tools designed to drive growth and customer engagement.
...
2. If you intend to use private apps for API access, note that while free HubSpot accounts can create private apps, certain API scopes and features may require a Professional or Enterprise plan subscription.
...
6. Navigate to the Scopes tab and select the required scopes for the CRM Engagements Email API (such as `crm.objects.contacts.read`, `crm.objects.contacts.write`, and `sales-email-read`).
